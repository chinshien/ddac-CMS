...
<body ><!--start body-->
    <div id="header" class="col-xs-12 col-md-12">
			<div class="col-xs-7 col-md-7" style="margin-left:-5%">
				<span style="font-size:80px;color:white;font-weight:bold">Maersk CMS</span>
			</div>
				<div class="col-xs-3 col-md-3" style="padding-top:3%">
            <p style="font-size:12px;color:white">Welcome, <span style="font-size:15px;font-weight: bold"><?php if(isset($userName)){
     echo $userName;
     }?></span></p>
  ...
  <ul class="menu" style="padding:20px">
    <li><span style="color:white">Menu</span>
      <ul class="sub-menu">
				<li><a href="<?php echo base_url();?>adminAll">View Administrator</a></li>
        ...
        <li><a href="<?php echo base_url();?>adminEditAdmin">Edit Administrator</a></li>
				  <li><a href="<?php echo base_url();?>adminSchedule">View Schedule</a></li>
					<li><a href="<?php echo base_url();?>createSchedule">Add Schedule</a></li>
					<li><a href="<?php echo base_url();?>editSchedule">Edit Schedule</a></li>
					<li><a href="<?php echo base_url();?>adminImport">Import/Export/Transshipment</a></li>
